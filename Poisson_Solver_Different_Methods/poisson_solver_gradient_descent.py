...
def alpha_k(r_k, A):
    return np.dot(r_k.T, r_k) / np.dot(np.dot(A, r_k).T, r_k)


for k in range(max_iter):

    alpha = alpha_k(r_prev, A)
...
#out of the program------------------------------------------------------------------------------------------
#No. of iterations to converge for tolerance 5e-7 = 16809 and computation time = 211 seconds
#--------------------------------------------------------------------------------------------------------------